...
const blogs = [
    {
        ...
        img: [Blog1Img],
        title: 'Archive 1',
        description: 'Papers can be submitted round the year 24x7x365. The paper shall be assigned to any specific volume and issue, only after its acceptance '
    },
    {
        id: 2,
        img: [Blog2Img],
        title: 'Archive 2',
        description: 'International Journal of Information Technology is a platform for the dissemination of original, scientific, theoretical or applied research in the fields of Computer Sciences and allied fields.'
    },
    {
        id: 3,
        img: [Blog3Img],
        title: 'Archive 3',
        description: 'BJIT - BVICAM’s International Journal of Information Technology having ISSN 0973 – 5658, being published by BVICAM, New Delhi, since last 08 years, is now being published quarterly (March, June, September & December) by Springer (The world’s largest publisher of scientific documents) w.e.f. Volume 09 Issue 01 from January, 2017 under ISSN: 2511-2104 (Print Version).'
    }
];
  ...
  return (
    ...
    <div className='home-page'>
        ...
        <div className='blog-section text-light py-5'>
            <div className='container d-flex flex-column align-items-center'>
                <h2 className='text-center text-capitalize mb-5'>Latest on the Archive</h2>
                ...
                <Link to="/blog">
                    <button type='button' className='btn btn-danger btn-lg mt-5'>Read More Archive</button>
                </Link>
            </div>
        </div>
    </div>
